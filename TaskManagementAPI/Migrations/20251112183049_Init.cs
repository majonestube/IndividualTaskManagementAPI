    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectVisibility", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectVisibility_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectVisibility_Projects_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectVisibility_ProjectId",
                table: "ProjectVisibility",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectVisibility_UserId",
                table: "ProjectVisibility",
                column: "UserId");
